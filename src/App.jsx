...
function FAQ() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "기본적인 추가 개발 비용은 전혀 없습니다. 199만원(50% 할인) 정액제 안에 반응형 하이엔드 홈페이지, 온라인 예약 연동, 검색엔진 최적화(SEO) 등 필수 기능이 모두 포함되어 있습니다. 단, 런칭 후 서버 호스팅 및 관리를 위한 월 유지보수 비용(5만원)만 별도로 발생합니다."
    },
    {
      q: "약속된 '단 4주 완성' 기간은 어떻게 보장되나요?",
      a: "저희는 한 번에 무리하게 다수의 병원 프로젝트를 쳐내지 않고, 체계적인 1:1 전담 개발 시스템으로 일정을 철저히 관리합니다. 원장님께서 디자인 컨펌과 피드백만 빠르게 주신다면, 4주 안에 완성된 결과물을 보장합니다."
    },
    {
      q: "월 5만원의 유지보수에는 어떤 서비스가 포함되나요?",
      a: "클라우드 서버 및 트래픽 비용, 보안 SSL 인증서 관리는 물론이고, 바쁘신 원장님을 대신하여 진료 시간 변경, 팝업 공지 등록, 간단한 이미지 및 텍스트 수정 등 철저한 사후 관리가 모두 무상 지원됩니다."
    },
    {
      q: "기존 홈페이지가 이미 있습니다. 리뉴얼을 해도 MOU 혜택이 적용되나요?",
      a: "네, 동일하게 적용됩니다. 기존 홈페이지의 낡은 디자인, 모바일 미지원, 느린 로딩 속도 등으로 고민이시라면, 최신 웹 트렌드에 맞춘 세련된 디자인과 안정적인 시스템으로 완벽하게 재구축해 드립니다."
    },
    {
